...
function LongCard({ title, children }) {
  return (
    <div className="mx-4 my-4 border hover:bg-black-dark-300 border-whiten rounded-md bg-black-dark-200 p-2 shadow-lg sm:mx-auto sm:max-w-full md:max-w-full lg:max-w-full">
