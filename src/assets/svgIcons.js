export const APP_LOGO = process.env.REACT_APP_FIREBASE_APP_LOGO_URL;
export const APP_USER_AVATAR =
  process.env.REACT_APP_FIREBASE_APP_USER_AVATAR_URL;
...
export const POSITIVE_STATUS_SVG = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const NEGATIVE_STATUS_SVG = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const NORMAL_STATUS_SVG = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const SEARCH_SVG = () => {
  return (
    <svg
      ...
      strokeWidth="1.5"
      stroke="currentColor"
      className="w-5 h-5 mx-3 text-black-dark-400 dark:text-whiten"
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
